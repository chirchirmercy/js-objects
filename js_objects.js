...
//an object that groups the products by their categories, with the category names as
// keys and the arrays of products as values.
//const products = [
  //{ name: 'Laptop', price: 1200, category: 'Electronics' },
  //{ name: 'Shirt', price: 25, category: 'Clothing' },
  //{ name: 'Headphones', price: 80, category: 'Electr

function arr(product){
  return  
}
...
// name and an array of scores, write a function that returns a new array containing the 
...
function Array(students){
  return students.filter(student=>student.score>=85,student=>student.name)
}
